...
from rlAgent import rlAgent, ReplayMemory, loop_play_forever
...
class Agent(rlAgent):
    ...
    def __init__(self, *args, **kwargs):
        rlAgent.__init__(self, *args, **kwargs)
...
def nv_state_preprocessor(state):
    ...
    max_values = np.array([100.0, 100.0, 100.0, 100.0])
...
if __name__ == "__main__":
    ...
    # for our agent.
    game = Maze(width=1366, height=768)
